...
export class SupplierService {
  ...
  public add(item: ISupplier): Observable<ISupplier> {
    return this.http.post<ISupplier>(this.REST_API_SERVER+this.ENDPOINT, item, httpOptions).pipe(
  ...
  public update(item: ISupplier): Observable<ISupplier> {
    return this.http.put<ISupplier>(this.REST_API_SERVER+this.ENDPOINT+"/"+item.id, item, httpOptions).pipe(
  ...
  public delete(item: ISupplier): Observable<ISupplier> {
    return this.http.delete<ISupplier>(this.REST_API_SERVER+this.ENDPOINT+"/"+item.id, httpOptions).pipe(
  ...
  public getBy(id: number): Observable<ISupplier> {
    return this.http.get<ISupplier>(this.REST_API_SERVER+this.ENDPOINT+"/"+id, httpOptions).pipe(
